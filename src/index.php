...
<html lang="de">
  ...
  <div id="wrapper">
    ...
    <main>
        <form action="index" class="pure-form pure-form-stacked" method="post">
            <input autofocus type="text" name="SpielID" placeholder="ABCD">
            <button class="pure-button pure-button-primary" type="submit" value="SpielBeitreten">Spiel beitreten</button>
        </form>
        <form action="index" class="pure-form pure-form-stacked" method="post">
            <button class="pure-button pure-button-primary" type="submit" value="NeuesSpiel" name="NeuesSpiel">Neues Spiel</button>
        </form>
